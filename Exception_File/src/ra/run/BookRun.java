...
public class BookRun {
    ...
    public static void updateBookById(Scanner scanner){
        ...
        try{
            ...
            if(indexUpdate >=0){
                books.get(indexUpdate).inputBookName(scanner);
                books.get(indexUpdate).inputImportPrice(scanner);
                books.get(indexUpdate).inputImportPrice(scanner);
                books.get(indexUpdate).inputExportPrice(scanner);
                books.get(indexUpdate).inputAuthor(scanner);
                books.get(indexUpdate).inputDescription(scanner);
            }else {
    ...
    public static void deleteBookById(Scanner scanner){
        ...
        try{
            ...
            if(indexDelete >=0){
                books.remove(books.get(indexDelete));
